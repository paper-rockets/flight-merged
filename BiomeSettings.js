const BASE_DEFAULTS = {
  ...
  treeScale: 1.5,
  treeDensity: 1.0,
  treeType1Visible: true,
  treeType2Visible: true,
  treeType3Visible: true,
  treeType4Visible: true,
  treeType5Visible: true,
  treeType6Visible: true,
  treeType7Visible: true,
  treeType8Visible: true,
  birdSounds: true,
  summerFilter: true,
  rain: false,
  rainIntensity: 0.5,
